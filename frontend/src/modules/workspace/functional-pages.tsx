  ...
  patients: [
    {
      ...
      status: "Ativo",
      notes: "Paciente inicial informada pelo profissional. Mulher, 28 anos, peso 87 kg, altura 160 cm e gordura corporal 28%.",
    },
  ],
  recipes: [],
  assessments: [
    {
      ...
      height: "160",
      bmi: "33.98",
      notes: "Avaliacao inicial cadastrada a partir dos dados informados.",
    },
  ],
  mealPlans: [],
  foods: [],
  ...
  bioimpedance: [
    {
      ...
      date: "2026-07-08",
      device: "",
      protocol: "Avaliacao inicial informada pelo profissional",
      bodyFat: "28",
      fatMass: "24.36",
      leanMass: "62.64",
      muscleMass: "",
      ...
      boneMass: "",
      bmr: "",
      notes: "Bioimpedancia inicial com 28% de gordura corporal. Revisar equipamento/protocolo quando disponivel.",
    },
  ],
  diary: [],
  focusGoals: [
    {
      ...
      target: "",
      status: "Em progresso",
      notes: "Definir meta clinica apos consulta.",
    },
    {
      id: "focus-gordeli-2",
      patientId: "patient-gordeli",
      ...
      target: "",
      status: "Em progresso",
      notes: "Meta deve ser definida conforme conduta profissional.",
    },
  ],
};
...
function mergeRequestedInitialPatient(store: Store): Store {
  if (store.patients.some((patient) => patient.id === "patient-gordeli")) return store;
  return {
    ...store,
